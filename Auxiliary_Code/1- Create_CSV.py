...
import statistics
os.chdir(r'C:\Users\giambelluca.144055\OneDrive\Doctorado\Datos_Laura\Capa_definitiva')

SHP_Claras=gpd.read_file('C_09082023.shp')
SHP_Control=gpd.read_file('Control_4326_filtro.shp')
SHP_Cortas=gpd.read_file('CH_09082023.shp')


#Establecimiento del directorio donde se encuentran los datos


os.chdir(r'C:\Users\giambelluca.144055\OneDrive\Doctorado\Resultados\Finales\B7_B6_4OBS')
B_t1=gdal.Open('CCDC_C_t1_B7_B6_4OBS.tif')
B_t2=gdal.Open('CCDC_C_t2_B7_B6_4OBS.tif')
B_t3=gdal.Open('CCDC_C_t3_B7_B6_4OBS.tif')
B_t4=gdal.Open('CCDC_C_t4_B7_B6_4OBS.tif')
B_t5=gdal.Open('CCDC_C_t5_B7_B6_4OBS.tif')
B_t6=gdal.Open('CCDC_C_t6_B7_B6_4OBS.tif')
...
os.chdir(r'C:\Users\giambelluca.144055\OneDrive\Doctorado\Datos_Laura\Raster_recortes\bandaxbanda\B2_B7')
cortas=gdal.Open('Raster_Control_ext_mod.tiff')
#cortas=gdal.Open('Raster_CH_ext_mod_f.tiff')
#cortas=gdal.Open('Raster_C_ext_mod_f.tiff')
...
Clarass=dC.copy()
Clarass.to_csv('Control_B7_B6_4Obs_Prob_MAG.csv', header=True, index=True)
